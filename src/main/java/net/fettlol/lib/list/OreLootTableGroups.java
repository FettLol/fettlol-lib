...
public class OreLootTableGroups {
    ...
    static {
        DIAMOND_ORES = Arrays.asList("minecraft:blocks/diamond_ore", "minecraft:blocks/deepslate_diamond_ore");
        LAPIS_ORES = Arrays.asList("minecraft:blocks/lapis_ore", "minecraft:blocks/deepslate_lapis_ore");

        if (ModIntegrationHelper.isModLoaded(Mods.DENSE_ORES)) {
            DIAMOND_ORES.addAll(List.of(
                "denseores:blocks/dense_deepslate_diamond_ore",
                "denseores:blocks/dense_diamond_ore")
            );

            LAPIS_ORES.addAll(List.of(
